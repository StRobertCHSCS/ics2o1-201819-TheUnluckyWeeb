...
#Declaring the location of the button.
button_x = 857
button_y = 535
button_width = 150
button_height = 50
...
def draw_button():
    arcade.draw_xywh_rectangle_filled(button_x, button_y, button_width, button_height, arcade.color.BLUE)
...
def draw_description():
    arcade.draw_text("Ever felt tired after a hard day of carrying? \nEver had back pains because of long grinding? \nEver felt like you lost because of a bad gaming chair? \nThen we have the right product for you! \nBuy the all new TOXIC gaming chair for only \n$999.99 today, and say goodbye to back pains! \nElectronic motors are not included.", 10, 400, arcade.color.LIGHT_BLUE, font_size = 20, font_name = "Impact")

#This is the specs in the lower right corner
def draw_specs():
    arcade.draw_text("SPECS: \nHeight: 1.5 meters \nWidth: 0.6 meters \nLength: 0.7 meters \nBack Support: Yes \nRGB: Yes \nSuspension: Yes", 1500, 500, arcade.color.LIGHT_CYAN, font_size = 25, font_name = "Impact")
