...
imgwe = 223
imghe = 600
imgf = arcade.load_texture("images/output.gif")
imgwf = 500
imghf = 430

#Button functions
buttonthingy = [857, 535, 150, 50]
sound = False
...
def on_update(delta_time):
    ...
    #New animations for sound
    if sound:
        y += vectorva
        if y > (HEIGHT - (imgha / 2)) or y < (imgha / 2):
            vectorva *= -1
...
def draw_button():
    arcade.draw_xywh_rectangle_filled(buttonthingy[0], buttonthingy[1], buttonthingy[2], buttonthingy[3], arcade.color.BLUE)
...
def draw_chair(x, y):
    arcade.draw_texture_rectangle(x, y, imgwa, imgha, imga)
...
def draw_effects():
    arcade.draw_texture_rectangle(imgwf/2, imghf/2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(imgwf + imgwf / 2, imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(2 * imgwf + imgwf / 2, imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(3* imgwf + imgwf / 2, imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(imgwf / 2, imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(imgwf + imgwf / 2, imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(2 * imgwf + imgwf / 2, imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(3 * imgwf + imgwf / 2, imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(imgwf / 2, 2 * imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(imgwf + imgwf / 2, 2 * imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(2 * imgwf + imgwf / 2, 2 * imghf + imghf / 2, imgwf, imghf, imgf)
    arcade.draw_texture_rectangle(3 * imgwf + imgwf / 2, 2 * imghf + imghf / 2, imgwf, imghf, imgf)
...
def on_mouse_press(x, y, button, modifiers):
    ...
    button_x, button_y, button_width, button_height = buttonthingy
